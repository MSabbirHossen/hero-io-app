...
export default AppDetailsPage;
                <div className="stat-value text-lg">{app.ratingAvg}</div>
              </div>
              <div className="stat bg-base-200 rounded p-4">
                <div className="stat-figure text-blue-500 text-2xl">📥</div>
              ...
              <div className="stat bg-base-200 rounded p-4">
                <div className="stat-figure text-green-500 text-2xl">💬</div>
              ...
              <div className="stat bg-base-200 rounded p-4">
                <div className="stat-figure text-purple-500 text-2xl">💾</div>
                <div className="stat-title">Size</div>
                <div className="stat-value text-lg">{app.size}MB</div>
              </div>
            </div>

            <button
              className={`btn btn-lg w-full ${
                installed ? "btn-success btn-disabled" : "btn-primary"
              }`}
              onClick={handleInstall}
              disabled={installed}
            >
        ...
        <div className="bg-base-200 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-bold mb-6">Reviews Distribution</h2>
          <ResponsiveContainer width="100%" height={400}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>Size: {app.size}MB</li>
                <li>Downloads: {(app.downloads / 1000000).toFixed(0)}M+</li>
                <li>Reviews: {(app.reviews / 1000).toFixed(0)}K+</li>
                <li>Rating: {app.ratingAvg}/5.0</li>
              </ul>
            </div>
            <div>
